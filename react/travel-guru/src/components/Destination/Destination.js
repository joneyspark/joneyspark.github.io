import { Box, Button, Card, CardActionArea, CardContent, CardMedia, Container, Grid, Typography } from '@material-ui/core';
...
const Destination = () => {
    ...
    const placeControllerSlider = getTravelData.map( (location) => 
        <SwiperSlide key={`controller=${location.id }`} className="placeSlider__Thumbnail">
